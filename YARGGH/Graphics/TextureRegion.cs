...
public class TextureRegion
{
    ...
    /// <summary>
    /// Gets or Sets the source rectangle boundary of this texture region
    ...
    /// <param name="x">The x-coordinate position of the upper-left corner of this texture region.</param>
    /// <param name="y">The y-coordinate position of the upper-left corner of this texture region.</param>
